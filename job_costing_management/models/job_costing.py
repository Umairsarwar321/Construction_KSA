...
class JobCosting(models.Model):
    ...
    #        string='Job Issue',
    #    ) #odoo11
    qautation_order_count = fields.Integer(
        compute='_qautation_order_count'
    )
    ...
    def action_open_job_quotation_form(self):
        ...
        if self.job_cost_line_ids:
            ...
            for job_cost_line_id in self.job_cost_line_ids:
                order_line_list.append((0, 0, {
                    ...
                    'product_uom': job_cost_line_id.uom_id.id,
                    'name': job_cost_line_id.description,
                    'price_unit': job_cost_line_id.cost_price,
                }))
        if self.job_labour_line_ids:
            ...
            for job_labour_line_id in self.job_labour_line_ids:
                order_line_list.append((0, 0, {
                    ...
                    'product_uom_qty': job_labour_line_id.hours,
                    'product_uom': 1,
                    'name': job_labour_line_id.description,
                    'price_unit': job_labour_line_id.cost_price,
                    'price_subtotal': job_labour_line_id.total_cost,
        ...
        if self.job_overhead_line_ids:
            ...
            for job_overhead_line_id in self.job_overhead_line_ids:
                order_line_list.append((0, 0, {
                    ...
                    'product_uom': job_overhead_line_id.uom_id.id,
                    'name': job_overhead_line_id.description,
                    'price_unit': job_overhead_line_id.cost_price,
        ...
        context = {
            ...
            'default_job_cost_id': self.id,
            'default_job_cost_number': self.id,
